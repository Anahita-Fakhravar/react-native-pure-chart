//node_modules/react-native-pure-chart/examples/pure-chart/common.js

import _ from 'lodash'
import React from 'react'
import {View, Text} from 'react-native'
import {responsiveHeight, responsiveWidth,responsiveFontSize} from 'react-native-responsive-dimensions';
import {myFontFamily} from "./FontFamily";
import {ConvertToFrNum} from "./ConvertToFrNum";
...
export const drawYAxisLabels = (arr, height, minValue, color = '#FFFFFF') => {
    return (
        <View style={{
            width: 37,
            height: height,
            ...
            {arr.length === 0 ? (
                ...
                return (
                    <View
                        ...
                        <Text style={{fontSize: responsiveFontSize(1.5),fontFamily:myFontFamily.bold, color: color}}>{ConvertToFrNum(v[0])}</Text>
                    </View>
                )
            })}
...
export const drawXAxisLabels = (sortedData, gap, color = '#FFFFFF', showEvenNumberXaxisLabel) => {
    return (
        <View style={{
            width: '100%',
            paddingVertical: 10,
                ...
                if (data['x'] && i % 2 === 1 || !showEvenNumberXaxisLabel) {
                    return (
                        <View key={'label' + i} style={{
                            ...
                            <Text style={{fontSize: responsiveFontSize(1.5),fontFamily: myFontFamily.bold, color: color}}>
                                {
                                    // data[3]
                                    ConvertToFrNum(data['x'])
                                }
                            </Text>
                        </View>
                    )
