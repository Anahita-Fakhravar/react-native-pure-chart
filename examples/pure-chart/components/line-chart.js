//node_modules/react-native-pure-chart/examples/pure-chart/components/line-chart.js
                        ...
                        {this.state.sortedData.map((series) => {
                            ...
                            return (
                                <View key={series.seriesName}>
                                    {dataObject.x ? (
                                        <Text style={styles.tooltipTitle}>{ConvertToFrNum(dataObject.x)}</Text>
                                    ) : null}
                                    <View style={{flexDirection: 'row', paddingLeft: 5, alignItems: 'center'}}>
                                        ...
                                        <Text style={styles.tooltipValue}>{numberWithCommas(ConvertToFrNum(dataObject.y), false)}</Text>
                                    </View>
                                </View>
                            )
                        })}
...
const styles = StyleSheet.create({
    ...
    tooltipTitle: {fontSize: responsiveFontSize(1.5),fontFamily:myFontFamily.regular},
    tooltipValue: {fontWeight: 'bold',  fontSize:responsiveFontSize(1.5),fontFamily:myFontFamily.regular}
})
